...
function Hero() {
  ...
  return (
    <div className="flex flex-col items-center mt-36 xl:mt-42 gap-2  px-4 py-10">
      <h2 className="font-bold text-4xl max-w-[30rem] text-center mb-4">{Lookup.HERO_HEADING}</h2>
